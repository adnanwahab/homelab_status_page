          ...
          try {
            ...
            return (
              typeof console !== void 0 &&
                ...
                console.warn("ðŸŽŠ Could not load worker", D),
              null
            );
          }
          P(m);
...
class Cs {
  ...
  getPage(e, t) {
    console.log("hello world"); // gen 16*4 nb -> with 5000 papers -> 10% wrk
    const r = {
    ...
    //console.log("asdfasdf adf adf asdf sd", e, r)
    typeof r == "function"
      ? r().then((n) => {
          console.log("rendering 2x?");
          //console.log("__", r)
          //debugger
